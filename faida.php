...
$sql2 = "SELECT SUM(product_price) AS product_price FROM mazaxtn";
$anjam2 = mysqli_query($connect, $sql2);
$mazaxtn = mysqli_fetch_assoc($anjam2);

 echo number_format($dahat['product_price'] - $mazaxtn['product_price']);
